      ...
      async function getData() {
        try {
          const response = await axios.get(
            `https://apigarage.njssolutions.in/api/v1/blog/getById/${id}`
          );
    ...
    try {
      ...
      if (!isUpdate) {
        const response = await axios.post(
          `https://apigarage.njssolutions.in/api/v1/blog/new`,
          formDataToSubmit
        );
        ...
        const response = await axios.put(
          `https://apigarage.njssolutions.in/api/v1/blog/update/${id}`,
          formDataToSubmit
        );
